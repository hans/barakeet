...
rule early_window_site_types:
    ...
    input:
        ...
        behav_dec_full      = "outputs/causal6/behavior_decoding_single_electrode_summarize/{subject}/peak_summary.parquet",
        behav_dec_hga_only  = "outputs/causal6/behavior_decoding_single_electrode_hga_only_summarize/{subject}/peak_summary.parquet",
    ...
    run:
        ...
        run_notebook(
            ...
            parameters=dict(
                ...
                trial_balance_path=str(input.trial_balance),
                outdir=str(outdir),
                behav_dec_full_path=str(Path(input.behav_dec_full).with_name("window_mean_scores.parquet")),
                behav_dec_hga_only_path=str(Path(input.behav_dec_hga_only).with_name("window_mean_scores.parquet")),
                min_class_k=C46["min_class_k"],
                window_size=C46["window_size"],
                stride=C46["stride"],
                R=1000,
