...
from _within_completion import extract_hga, matched_n_star_plot, resolve_behavior_col
...
# matched_n_star_plot is defined in _within_completion.py (imported above).
