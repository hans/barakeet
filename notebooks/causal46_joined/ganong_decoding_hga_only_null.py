...
# %% [markdown]
# Sync source: notebooks/causal6/ganong_decoding_hga_only_null.py
#
...
null_stage1_raw = run_ganong_hga_only_permutations(
...
null_stage1 = preagg_ganong_hga_only_null(null_stage1_raw, real_scores)
del null_stage1_raw
...
if borderline_keys and n_permutations_stage2 > 0:
    ...
    null_stage2 = preagg_ganong_hga_only_null(null_stage2_raw, real_scores)
    del null_stage2_raw
...
if fdr_rois and electrode_dfs_paths and n_permutations_stage3 > 0:
    ...
    null_scores, gate_log = stage3_boost(
        ...
        preagg_fn=preagg_ganong_hga_only_null,
